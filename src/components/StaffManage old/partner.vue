<template>
  <div class="partnerMemberManageApp">
    <main>
      ...
      <div class="container">
        <el-card class="box-card" v-for="(org,key) in orgs" :key="key">
...
<script>
import { getVendorEmployeeByDepartment, getVendorEmployeeByProject, getVendorEmployeeByArea ,submitEmployJobTime} from '../../api/api'
export default {
  props: ['transData'],
  data () {
    return {
  ...
  methods: {
      queryMember(){
        ...
        switch(this.orgType){
          case '1':
            this.getVendorEmployeeByDepartment(queryData)
            break
          case '2':
            this.getVendorEmployeeByProject(queryData)
            break
          case '3':
            this.getVendorEmployeeByArea(queryData)
            break
        }
      ...
      //按部门获取人员信息
      getVendorEmployeeByDepartment(queryData){
      ...
      //按项目获取人员信息
      getVendorEmployeeByProject(queryData){
         //从后台获取数据
        getVendorEmployeeByProject(queryData)
            .then(res => {
                if (res.state === 1000) {
      ...
      //按地区获取人员信息
      getVendorEmployeeByArea(queryData){
         //从后台获取数据
        getVendorEmployeeByArea(queryData)
            .then(res => {
                if (res.state === 1000) {
...
<style>
.partnerMemberManageApp {
  width: 100%
}

.partnerMemberManageApp > main > .top {
  margin-top: 20px;
  margin-bottom: 40px;
  position: relative
}
.partnerMemberManageApp > main > .top > .el-input {
  float: left;
  margin-left: 20px;
  width: 150px;
  margin-right: 30px;
}
.partnerMemberManageApp > main > .top > .el-select {
  float: left;
  margin-left: 20px;
  width: 150px;
  margin-right: 30px;
...
.partnerMemberManageApp > main > .top > .el-select > .el-input > .el-input__inner {
  height: 40px
}



.partnerMemberManageApp > main {
  width: 1188px;
  margin: 10px auto;
  min-height: 100px
}

.partnerMemberManageApp > main > .container > .el-card > .el-card__body > div > .el-pagination {
  padding-left: 0px;
  margin-top: 5px;
  /* padding: 0px 0px */
  /* background-color: yellow; */
}
.partnerMemberManageApp > main > .container > .el-card > .el-card__body > div > .el-pagination .el-input{
  margin-left: 0px;
}

.partnerMemberManageApp > main > .middle {
  margin-top: 80px;
  margin-bottom: 20px
}
.partnerMemberManageApp > main > .middle > div > ul {
  list-style: none;
  padding: 0;
  margin: 0;
  padding-left: 20px
}
.partnerMemberManageApp > main > .middle > div > ul > li {
  width: 1148px;
  background-color: #F2F6FC;
  font-size: 18px;
  padding: 3px 0px
}
.partnerMemberManageApp > .seeTestPeople > .el-dialog > .el-dialog__body > .el-table > .el-table__header-wrapper > .el-table__header > thead > tr > th {
  padding: 8.5px 0px
}
.partnerMemberManageApp > .seeTestPeople > .el-dialog > .el-dialog__body > .el-table > .el-table__body-wrapper {
  min-height: 50px;
  max-height: 250px;
  overflow-y: auto;
  overflow-x: hidden
}
.partnerMemberManageApp > .seeTestPeople > .el-dialog > .el-dialog__body > .el-table > .el-table__body-wrapper > .el-table__body > tbody > tr > td {
  padding: 13px 0px
}
.partnerMemberManageApp > main > .container {
  width: 1148px;
  margin: 10px 0 20px 20px;
  min-height: 200px
}
.partnerMemberManageApp > main > .container > .el-card {
  margin-bottom: 20px
}
.partnerMemberManageApp > main > .container > .el-card > .el-card__header {
  padding: 5px 20px
}
.partnerMemberManageApp > main > .container > .el-card > .el-card__body > .el-table th {
  padding: 4px 0
}
.partnerMemberManageApp > main > .container > .el-card > .el-card__body > .el-table td {
  padding: 4px 0
}
.partnerMemberManageApp > main > .container > footer {
  text-align: center
}
.partnerMemberManageApp > .canCases > .el-dialog > .el-dialog__body > .el-tree {
  max-height: 500px;
  overflow-x: auto;
  overflow-y: auto
}
.partnerMemberManageApp > .canCases > .el-dialog > .el-dialog__body > footer {
  margin-top: 20px;
  height: 30px
}
.partnerMemberManageApp > .canCases > .el-dialog > .el-dialog__body > footer > .el-button {
  float: right
}
</style>
