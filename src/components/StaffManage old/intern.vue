<template>
  <div class="internMemberManageApp">
    <main>
       <div class="top">
...
<script>
import { getInternEmployeeByDepartment, getInternEmployeeByProject, getInternEmployeeByArea,submitEmployJobTime } from '../../api/api'
export default {
  props: ['transData'],
  data () {
    return {
  ...
  methods: {
      queryMember(){
        ...
        switch(this.orgType){
          case '1':
            this.getInternEmployeeByDepartment(queryData)
            break
          case '2':
            this.getInternEmployeeByProject(queryData)
            break
          case '3':
            this.getInternEmployeeByArea(queryData)
            break
        }
      ...
      //按部门获取人员信息
      getInternEmployeeByDepartment(queryData){
      ...
      //按项目获取人员信息
      getInternEmployeeByProject(queryData){
         //从后台获取数据
        getInternEmployeeByProject(queryData)
            .then(res => {
                if (res.state === 1000) {
      ...
      //按地区获取人员信息
      getInternEmployeeByArea(queryData){
         //从后台获取数据
        getInternEmployeeByArea(queryData)
            .then(res => {
                if (res.state === 1000) {
...
<style>
.internMemberManageApp {
  width: 100%
}

.internMemberManageApp > main > .top {
  margin-top: 20px;
  margin-bottom: 40px;
  position: relative
}
.internMemberManageApp > main > .top > .el-input {
  float: left;
  margin-left: 20px;
  width: 150px;
  margin-right: 30px;
}
.internMemberManageApp > main > .top > .el-select {
  float: left;
  margin-left: 20px;
  width: 150px;
  margin-right: 30px;
...
.internMemberManageApp > main > .top > .el-select > .el-input > .el-input__inner {
  height: 40px
}



.internMemberManageApp > main {
  width: 1188px;
  margin: 10px auto;
  min-height: 100px
}

.internMemberManageApp > main > .container > .el-card > .el-card__body > div > .el-pagination {
  padding-left: 0px;
  margin-top: 5px;
  /* padding: 0px 0px */
  /* background-color: yellow; */
}
.internMemberManageApp > main > .container > .el-card > .el-card__body > div > .el-pagination .el-input{
  margin-left: 0px;
}

.internMemberManageApp > main > .middle {
  margin-top: 80px;
  margin-bottom: 20px
}
.internMemberManageApp > main > .middle > div > ul {
  list-style: none;
  padding: 0;
  margin: 0;
  padding-left: 20px
}
.internMemberManageApp > main > .middle > div > ul > li {
  width: 1148px;
  background-color: #F2F6FC;
  font-size: 18px;
  padding: 3px 0px
}
.internMemberManageApp > .seeTestPeople > .el-dialog > .el-dialog__body > .el-table > .el-table__header-wrapper > .el-table__header > thead > tr > th {
  padding: 8.5px 0px
}
.internMemberManageApp > .seeTestPeople > .el-dialog > .el-dialog__body > .el-table > .el-table__body-wrapper {
  min-height: 50px;
  max-height: 250px;
  overflow-y: auto;
  overflow-x: hidden
}
.internMemberManageApp > .seeTestPeople > .el-dialog > .el-dialog__body > .el-table > .el-table__body-wrapper > .el-table__body > tbody > tr > td {
  padding: 13px 0px
}
.internMemberManageApp > main > .container {
  width: 1148px;
  margin: 10px 0 20px 20px;
  min-height: 200px
}
.internMemberManageApp > main > .container > .el-card {
  margin-bottom: 20px
}
.internMemberManageApp > main > .container > .el-card > .el-card__header {
  padding: 5px 20px
}
.internMemberManageApp > main > .container > .el-card > .el-card__body > .el-table th {
  padding: 4px 0
}
.internMemberManageApp > main > .container > .el-card > .el-card__body > .el-table td {
  padding: 4px 0
}
.internMemberManageApp > main > .container > footer {
  text-align: center
}
.internMemberManageApp > .canCases > .el-dialog > .el-dialog__body > .el-tree {
  max-height: 500px;
  overflow-x: auto;
  overflow-y: auto
}
.internMemberManageApp > .canCases > .el-dialog > .el-dialog__body > footer {
  margin-top: 20px;
  height: 30px
}
.internMemberManageApp > .canCases > .el-dialog > .el-dialog__body > footer > .el-button {
  float: right
}
</style>
