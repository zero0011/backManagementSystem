...
<!-- 选择栏模块 -->
  ...
  <div class="container1"  v-loading="loading" element-loading-text="正在生成中">
  <template v-if="!query">
    ...
    <el-card class="box-card elelCard" v-for="(item, index) in tableData" :key="index" style="margin-bottom: 20px">
...
export default {
    ...
    methods:{
      ...
      {
        this.sums[0]='总计'
        this.sums[1]='过度负载:'+summary.heavyLoad
        this.sums[2]='满负载:'+summary.normalLoad
        this.sums[3]='普通负载:'+summary.lightLoad
        this.sums[4]='空闲负载:'+summary.freeLoad
        this.sums[5]=' '
        this.sums[6]=' '
        return this.sums
          ...
          if (res.state === 1000) {
            ...
            for(let index in this.tableData)
            {
              this.tableData[index].details.push({
                ...
                "projectNames":"满负载: "+this.tableData[index].summary.normalLoad+"(人)",
                "personType":"普通负载: "+this.tableData[index].summary.lightLoad+"(人)",
                "manpowerVal":"空闲负载: "+this.tableData[index].summary.freeLoad+"(人)"
              })
            }
            }
            ...
            if(this.CategoryType == 1)//按部门
            {
                 ...
                 //这是预处理，为了防止重新加载data的时候标签的样式还保存，比如最后一个行是第三行，再切换第三行元素还在
                    this.$nextTick(() => {
                    ...
                    arr.forEach((ele,index)=>{
                      ...
                      {        
                        ...
                        temp.forEach((ele,index)=>{
                          ...
                          Tdarr[3].style.color='#606266'
                          Tdarr[4].style.color='#606266'
                          Tdarr[5].style.color='#606266'
                        })
                      }
                   ...
                   this.$nextTick(() => {
                    ...
                    arr.forEach((ele,index)=>{
                      ...
                      {        
                        ...
                        Tdarr[3].style.color='#E6A23C'//橙
                        Tdarr[4].style.color='#67C23A'//绿
                        Tdarr[5].style.color='#409EFF'//蓝
                      }
...
           }
       ...
       //  console.log(typeof this.CategoryType)
        ...
        .then(res => {
          if (res.state === 1000) {
            ...
            if(this.DepartmentLevel!='')
            {
              ...
              this.PageData[0].details.push(tempObj)
        ...
        //点击删除按钮，移除haveBindProject数据,而且把可选项继续可选
...
.resourceApp1 > .top >.el-input {
  width: 150px;
  margin-right: 20px;
}
.resourceApp1 > .top >.el-button {
  margin-left: 30px;
}
.resourceApp1 > .top >.el-select {
  margin-left: 200px;
}
.resourceApp1 > .top > .el-button:nth-of-type(1) {
  margin-left: 100px
}
.resourceApp1 > .top > .el-button:nth-of-type(2) {
  margin-left: 280px
}
/* .resourceApp1 > .top >.queryProject {
    margin-left: 260px;
} */
.resourceApp1 > .container1 {
width: 1148px;
...
.resourceApp1 > .container1 > .tb > .el-pagination{
  float: left;
  margin-left: 10px;
  margin-right: 30px;
}
 .container1 .light #fullLoad {
...
.container1 .light #context {
float: left;
margin-left: 8px
}
.resourceApp1 > .projectDialog > .el-dialog > .el-dialog__body{
  height: 450px;
  overflow-y:auto
}
.resourceApp1 > .bindProject > .el-dialog{
  width: 1000px;
  height: 600px
}

.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body {
  padding: 0;
  margin: 0;
  width: 100%;
  height: 500px;
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .left {
  width: 300px;
  float: left;
  margin-left: 30px
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .left > .query{
  width: 100%;
  float: left;
  position: relative;
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .left > .query >.el-button{
  width: 23%;
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .left > .query >.el-input{
  width:75%;
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .left > h2 {
  width: 100%;
  height: 50px;
  line-height: 50px;
  text-align: center;
...
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .left > .el-tree {
  width: 298px;
  height: 448px;
...
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .middle {
  width: 80px;
  float: left;
  height: 500px;
  display: flex;
...
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .middle > .el-button {
  width: 80px;
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right {
  width: 450px;
  float: left;
  height: 500px;
  margin-left: 50px
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right > h2 {
  width: 100%;
  height: 50px;
  line-height: 50px;
  text-align: center;
...
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right > .table{
  width: 448px;
  height: 450px;
  border-left: 1px solid #DCDFE6;
  border-right: 1px solid #DCDFE6
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table {
  width: 448px;
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table > .el-table__header-wrapper > .el-table__header > thead > tr > th:first-of-type{
  border-right: 1px solid #DCDFE6
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table > .el-table__body-wrapper {
  height: 398px;
  overflow-y: auto
}
.resourceApp1 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table > .el-table__body-wrapper > .el-table__body > tbody > tr > td:first-of-type {
  border-right: 1px solid #DCDFE6;
  height: 40px;
  padding: 3px 0;
}
/* .resourceApp1 >.container1  .el-table tbody tr:hover {
  background-color: red

} */
/* .resourceApp5 >.container5  .el-table tbody tr:last-of-type {
  background-color: #E4E7ED
}

.resourceApp5 >.container5  .el-table tbody tr:last-of-type:hover>td{
  background-color: #E4E7ED
}

.resourceApp5 >.container5  .el-table tbody tr:last-of-type:hover>td:nth-of-type(3){
  color: red ;
}
.resourceApp5 >.container5  .el-table tbody tr:last-of-type>td:nth-of-type(3){
  color: red ;
}
.resourceApp5 >.container5  .el-table tbody tr:last-of-type:hover>td:nth-of-type(4){
  color: #E6A23C ;
}
.resourceApp5 >.container5  .el-table tbody tr:last-of-type>td:nth-of-type(4){
  color: #E6A23C ;
}
.resourceApp5 >.co22222ntainer5  .el-table tbody tr:last-of-type:hover>td:nth-of-type(5){
  color: #67C23A ;
}
.resourceApp5 >.container5  .el-table tbody tr:last-of-type>td:nth-of-type(5){
  color: #67C23A ;
}
.resourceApp5 >.container5  .el-table tbody tr:last-of-type:hover>td:nth-of-type(6){
  color: #409EFF ;
}
.resourceApp5 >.container5  .el-table tbody tr:last-of-type>td:nth-of-type(6){
  color: #409EFF ;
} */
</style>