...
<div class="container2"  v-loading="loading" element-loading-text="正在生成中">
  <template v-if="!query">
          ...
          if (res.state === 1000) {
            ...
            for(let index in this.tableData)
            {
              this.tableData[index].details.push({
                ...
                "orgName":"满负载: "+this.tableData[index].summary.normalLoad+"(人)",
              })
            }
            }
...
.resourceApp2 > .top >.el-input {
    width: 150px;
    margin-right: 20px;
}
.resourceApp2 > .top >.el-button {
    margin-left: 30px;
}
.resourceApp2 > .top >.el-select {
    margin-left: 200px;
}
.resourceApp2 > .top > .el-button:nth-of-type(1) {
  margin-left: 100px
}
.resourceApp2 > .top > .el-button:nth-of-type(2) {
  margin-left: 280px
}
.resourceApp2 > .container2 {
width: 1148px;
...
.resourceApp2 > .container2 > .tb > .el-pagination{
  float: left;
  margin-left: 10px;
  margin-right: 30px;
}
 .container2 .light #fullLoad {
...
.container2 .light #context {
float: left;
margin-left: 8px
}
.resourceApp2 > .projectDialog > .el-dialog > .el-dialog__body{
  height: 450px;
  overflow-y:auto
}
.resourceApp2 > .bindProject > .el-dialog{
  width: 1000px;
  height: 600px
}

.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body {
  padding: 0;
  margin: 0;
  width: 100%;
  height: 500px;
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .left {
  width: 300px;
  float: left;
  margin-left: 30px
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .left > .query{
  width: 100%;
  float: left;
  position: relative;
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .left > .query >.el-button{
  width: 23%;
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .left > .query >.el-input{
  width:75%;
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .left > h2 {
  width: 100%;
  height: 50px;
  line-height: 50px;
  text-align: center;
...
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .left > .el-tree {
  width: 298px;
  height: 448px;
...
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .middle {
  width: 80px;
  float: left;
  height: 500px;
  display: flex;
...
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .middle > .el-button {
  width: 80px;
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right {
  width: 450px;
  float: left;
  height: 500px;
  margin-left: 50px
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right > h2 {
  width: 100%;
  height: 50px;
  line-height: 50px;
  text-align: center;
...
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right > .table{
  width: 448px;
  height: 450px;
  border-left: 1px solid #DCDFE6;
  border-right: 1px solid #DCDFE6
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table {
  width: 448px;
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table > .el-table__header-wrapper > .el-table__header > thead > tr > th:first-of-type{
  border-right: 1px solid #DCDFE6
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table > .el-table__body-wrapper {
  height: 398px;
  overflow-y: auto
}
.resourceApp2 > .bindProject > .el-dialog > .el-dialog__body > .right > .table > .el-table > .el-table__body-wrapper > .el-table__body > tbody > tr > td:first-of-type {
  border-right: 1px solid #DCDFE6;
  height: 40px;
  padding: 3px 0
}
