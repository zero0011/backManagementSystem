            ...
            <el-table :data="org.details" tooltip-effect="dark" style="width: 100%" border :header-cell-style="{background:'rgb(250, 250, 250)'}">
              ...
              >
                <template slot-scope="scope">
                  <p v-if="!showOption(scope.row.realName)">{{scope.row.area}}</p>
                  <el-select
        ...
        if (res.state === 1000) {
          ...
          for (let index in this.orgs) {
            this.orgs[index].details.push({
              'realName': '总计',
              'accountName': '全部: ' + this.orgs[index].summary.all + '(人)',
              'department': '正式: ' + this.orgs[index].summary.regular + '(人)',
              'mail': '合作方: ' + this.orgs[index].summary.partner + '(人)',
              'area': '实习: ' + this.orgs[index].summary.intern + '(人)'
            })
          }
        } else {
          setTimeout(() => {
...
.allMemberManageApp > main > .top {
  margin-top: 20px;
  margin-bottom: 40px;
  position: relative;
}
.allMemberManageApp > main > .top > .el-input {
  float: left;
  margin-left: 20px;
  width: 150px;
  margin-right: 30px;
}
.allMemberManageApp > main > .top > .el-select {
  float: left;
  margin-left: 20px;
  width: 150px;
  margin-right: 30px;
...
.allMemberManageApp > main > .top > .el-select > .el-input > .el-input__inner {
  height: 40px;
}

.allMemberManageApp > main {
  width: 1188px;
  margin: 10px auto;
  min-height: 100px;
}
...
.allMemberManageApp > main > .middle {
  margin-top: 80px;
  margin-bottom: 20px;
}
.allMemberManageApp > main > .middle > div > ul {
  list-style: none;
  padding: 0;
  margin: 0;
  padding-left: 20px;
}
.allMemberManageApp > main > .middle > div > ul > li {
  width: 1148px;
...
.allMemberManageApp > main > .container {
  width: 1148px;
  margin: 10px 0 20px 20px;
  min-height: 200px;
}
.allMemberManageApp > main > .container > .el-card {
  margin-bottom: 20px;
}
.allMemberManageApp > main > .container > .el-card > .el-card__header {
  padding: 5px 20px;
}
.allMemberManageApp
  > main
...
.allMemberManageApp > main > .container > footer {
  text-align: center;
}
.allMemberManageApp > .canCases > .el-dialog > .el-dialog__body > .el-tree {
  max-height: 500px;
  overflow-x: auto;
  overflow-y: auto;
}
.allMemberManageApp > .canCases > .el-dialog > .el-dialog__body > footer {
  margin-top: 20px;
  height: 30px;
}
.allMemberManageApp
...
.allMemberManageApp > main .el-table tbody tr:last-of-type {
  background-color: #e4e7ed;
}

.allMemberManageApp > main .el-table tbody tr:last-of-type:hover > td {
  background-color: #e4e7ed;
}
.allMemberManageApp
  > main
...
.allMemberManageApp > main .el-table tbody tr:last-of-type > td:nth-of-type(1) {
  font-weight: 600;
}
.allMemberManageApp
  > main
...
.allMemberManageApp > main .el-table tbody tr:last-of-type > td:nth-of-type(2) {
  color: black;
}
.allMemberManageApp
  > main
...
.allMemberManageApp > main .el-table tbody tr:last-of-type > td:nth-of-type(3) {
  color: #409eff;
}
.allMemberManageApp
  > main
...
.allMemberManageApp > main .el-table tbody tr:last-of-type > td:nth-of-type(4) {
  color: #e6a23c;
}
.allMemberManageApp
  > main
...
.allMemberManageApp > main .el-table tbody tr:last-of-type > td:nth-of-type(5) {
  color: #67c23a;
}
</style>
